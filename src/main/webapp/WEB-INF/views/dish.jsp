...
<body>
	...
	<div class="card container mt-5">
		...
		<form action="${pageContext.request.contextPath}/home_restaurant" method="post" >
		<div class="form-group">
				<label for="dishname">Restaurant Name</label> <input
		...
		<div class="form-group">
				<label for="dishname">Dish Name</label> <input
					type="text" class="form-control" id="rname"
					aria-describedby="emailHelp" placeholder="Enter your dish name"
					name="dishName" required>
			</div>
			<div class="form-group">
				<label for="dishprice">Dish Price</label> <input
					type="text" class="form-control" id="mobile"
					aria-describedby="emailHelp" placeholder="Enter Dish price per plate"
					name="dishPrice" required>
			</div>
			<div class="form-group">
